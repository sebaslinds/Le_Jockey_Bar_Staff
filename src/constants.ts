...
export const TRANSLATIONS = {
  en: {
    ...
    noKeepIt: 'No, keep it',
    chatbotTitle: 'Staff Assistant',
    chatbotPlaceholder: 'Ask Staff Assistant...',
    chatbotInitialMessage: 'Hello! I am your Staff Assistant. How can I help you manage the floor today?',
    empty: 'EMPTY',
    all: 'ALL',
  ...
  fr: {
    ...
    noKeepIt: 'Non, la garder',
    chatbotTitle: 'Assistant Employé',
    chatbotPlaceholder: 'Demandez à l\'Assistant Employé...',
    chatbotInitialMessage: 'Bonjour ! Je suis l\'Assistant Employé. Comment puis-je vous aider à gérer la salle aujourd\'hui ?',
    empty: 'VIDE',
    all: 'TOUS',
    unassigned: 'NON ASSIGNÉ',
    team: 'ÉQUIPE',
    generateOrders: 'Générer des commandes',
